...
## About The Project
This repository contains a collection of web development projects and laboratory assignments created during the "Introduction to Web Applications" university course. The projects demonstrate a progressive learning path from basic static web pages to interactive games and modern component-based applications.
